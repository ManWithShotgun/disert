...
\chapter{... АЛГОРИТМОВ И ТЕХНОЛОГИЙ РЕШЕНИЯ ПОСТАВЛЕННОЙ ЗАДАЧИ}
\section{Моделирование реализаций случайных процессов}
\input{src/modeling}
\section{Имитационное моделирование в процессе ...}
\input{src/imitation-modeling}
\section{Выводы}
\input{src/summary-2}


\chapter{Разработка ИМИТАЦИОННАЯ МОДЕЛЬ и средств реализации имитационного моделирования}
...
\section{Вычислитель эксперимент}
